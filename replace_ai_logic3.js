...
Dưới đây là một phần của bộ đề thi trắc nghiệm. Nhiệm vụ của bạn là đóng vai một Trợ giảng:
...
YÊU CẦU BẮT BUỘC:
1. Tuyệt đối KHÔNG ĐƯỢC tự ý sửa hay xóa nội dung gốc.
2. KHÔNG thay đổi từ ngữ, không phá vỡ định dạng A, B, C, D của bộ đề.
3. Chỉ trả về nội dung bộ đề gốc đã được chèn thêm dòng "Giải thích: [Nội dung giải thích]" ở cuối mỗi câu hỏi. Không chèn thẻ markdown.
...
\`;
            ...
            try {
                ...
                hiddenAIText = finalResult.trim(); // Compatibility with old code
        ...
        console.log('Replaced AI logic properly');
    } else {
